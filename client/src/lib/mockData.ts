...
export const mockMagazines: Magazine[] = [
  { id: 1, title: "Vogue", publisher: "Condé Nast", category: "Fashion", price: 12.99, stock: 450, sku: "VOG-2024-05", status: "active", coverUrl: "https://images.unsplash.com/photo-1548142813-c348350df52b?auto=format&fit=crop&q=80&w=600", description: "The leading fashion magazine covering style, beauty, and culture." },
  { id: 2, title: "National Geographic", publisher: "Disney", category: "Science", price: 9.99, stock: 120, sku: "NG-2024-05", status: "active", coverUrl: "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?auto=format&fit=crop&q=80&w=600", description: "Exploring the world, science, and nature." },
  ...
  { id: 5, title: "The New Yorker", publisher: "Condé Nast", category: "Culture", price: 8.99, stock: 200, sku: "NY-2024-05", status: "active", coverUrl: "https://images.unsplash.com/photo-1555449380-492987ebdb83?auto=format&fit=crop&q=80&w=600", description: "Commentary on politics and culture." },
  ...
  { id: 8, title: "Cereal", publisher: "Cereal", category: "Travel", price: 20.00, stock: 25, sku: "CRL-2024-05", status: "active", coverUrl: "https://images.unsplash.com/photo-1493723843689-d6021ea62299?auto=format&fit=crop&q=80&w=600", description: "Travel and style magazine." },
